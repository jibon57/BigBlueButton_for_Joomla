 ...
 */
class BigbluebuttonModelMeeting extends JModelItem
{
	/**
	 ...
	 * @var        string
	 */
	protected $_context = 'com_bigbluebutton.meeting';
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('meeting.id');
		...
		if (!isset($this->_item[$pk]))
		{
			...
			$this->_dispatcher = JEventDispatcher::getInstance();
				...
				$this->_dispatcher->trigger("onContentPrepare", array('com_bigbluebutton.meeting.description', &$_description, &$this->params, 0));
