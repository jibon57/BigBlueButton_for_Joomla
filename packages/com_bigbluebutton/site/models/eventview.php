 ...
 */
class BigbluebuttonModelEventview extends JModelItem
{
	/**
	 ...
	 * @var        string
	 */
	protected $_context = 'com_bigbluebutton.eventview';
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('eventview.id');
