...
class BigbluebuttonControllerMeeting extends JControllerForm
{
	...
	{
		$this->view_list = 'Meetings'; // safeguard for setting the return view listing to the main view.
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Meeting', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_bigbluebutton&view=meetings' . $this->getRedirectToListAppend(), false));
