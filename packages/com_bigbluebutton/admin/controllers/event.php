 ...
 * Event Controller
 */
class BigbluebuttonControllerEvent extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Events'; // safeguard for setting the return view listing to the main view.
	...
	protected function allowAdd($data = array())
	{
		...
		// Access check.
		$access = $user->authorise('event.access', 'com_bigbluebutton');
		if (!$access)
		{
			return false;
		}
		...
		return $user->authorise('event.create', $this->option);
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_bigbluebutton&view=events' . $this->getRedirectToListAppend(), false));
