 ...
 */
class BigbluebuttonTableMeeting extends JTable
{
	/**
	...
	/**
	 * Overload the store method for the Meeting table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New meeting. A meeting created and created_by field can be set by the user,
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_bigbluebutton.meeting.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_bigbluebutton.meeting.'.(int) $this->$k;
	}
