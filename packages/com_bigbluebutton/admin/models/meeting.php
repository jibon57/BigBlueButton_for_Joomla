...
{    
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_bigbluebutton.meeting';
	...
	{
		return 'administrator/components/com_bigbluebutton/models/forms/meeting.js';
	}
	...
	public function validate($form, $data, $group = null)
	{
		...
		if (BigbluebuttonHelper::checkString($data['not_required']))
		{
			...
			foreach ($requiredFields as $requiredField)
			{
				...
				if (BigbluebuttonHelper::checkString($requiredField))
				{
					// change to false
