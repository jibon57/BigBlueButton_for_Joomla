...
class BigbluebuttonViewMeeting extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_bigbluebutton/assets/css/meeting.css", (BigbluebuttonHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css'); 
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_bigbluebutton/views/meeting/submitbutton.js", (BigbluebuttonHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
