...
JFactory::getDocument()->addScript(JURI::base().'components/com_bigbluebutton/assets/jquery-1.11.2.min.js');
JFactory::getDocument()->addStyleSheet(JURI::base().'components/com_bigbluebutton/assets/bootstrap-forms.css');
